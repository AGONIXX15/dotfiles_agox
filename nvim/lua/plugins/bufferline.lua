return {
  ...
  config = function()
    ...
    vim.api.nvim_set_keymap('n', '<leader><C-l>', ':BufferLineCycleNext<CR>', { noremap = true, silent = true })
    vim.api.nvim_set_keymap('n', '<leader><C-h>', ':BufferLineCyclePrev<CR>', { noremap = true, silent = true })
